// Rodapé compartilhado do Oliver: crédito discreto + contato via WhatsApp.
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (nav && nav.parentElement) {
        nav.parentElement.insertBefore(credito, nav);
    } else {
        var card = document.querySelector(".sm\\:max-w-sm") || document.querySelector(".max-w-sm") || document.body;
